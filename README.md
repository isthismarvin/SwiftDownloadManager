...
App and Chrome extension share the same version (**v2.0.0**).

| Asset | Download |
|-------|----------|
| macOS app (recommended) | [SwiftDownloadManager-macOS-v2.0.0.dmg](https://github.com/isthismarvin/SwiftDownloadManager/releases/latest/download/SwiftDownloadManager-macOS-v2.0.0.dmg) |
| macOS app (zip) | [SwiftDownloadManager-macOS-v2.0.0.zip](https://github.com/isthismarvin/SwiftDownloadManager/releases/latest/download/SwiftDownloadManager-macOS-v2.0.0.zip) |
| Chrome extension | [SwiftDownloadManager-ChromeExtension-v2.0.0.zip](https://github.com/isthismarvin/SwiftDownloadManager/releases/latest/download/SwiftDownloadManager-ChromeExtension-v2.0.0.zip) |
...
1. Download and unzip [SwiftDownloadManager-ChromeExtension-v2.0.0.zip](https://github.com/isthismarvin/SwiftDownloadManager/releases/latest/download/SwiftDownloadManager-ChromeExtension-v2.0.0.zip).
